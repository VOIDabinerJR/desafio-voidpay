# Desafio Back-end VOIDpay

Primeiramente, obrigado pelo seu interesse em trabalhar connosco!
Abaixo você encontrará todos as informações necessárias para iniciar o seu teste.

## Avisos antes de começar

- Leia com atenção este documento todo e tente seguir ao **máximo** as instruções;
- Crie um repositório no seu GitHub **sem citar nada relacionado ao VOIDpay**;
...
## Objetivo: VOIDpay Simplificado

O VOIDpay Simplificado é uma plataforma de pagamentos simplificada. Nela é possível depositar e realizar transferências
...
A seguir estão algumas regras de negócio que são importantes para o funcionamento do VOIDpay Simplificado:

- Para ambos tipos de usuário, precisamos do `Nome Completo`, `BI`, `e-mail` e `Senha`. BI/NUIT e e-mails devem ser
  únicos no sistema. Sendo assim, seu sistema deve permitir apenas um cadastro com o mesmo BI ou endereço de e-mail;
